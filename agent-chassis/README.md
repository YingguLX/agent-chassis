...
- `agents/RULES.md`: engineering constraints, non-breakable constraints, automatic quality guard, implicit quality guard, and user manual writing rules.
