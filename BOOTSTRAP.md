...
- Check results for `BOOTSTRAP.md` one-time external prompt identity, six-document back-reference prohibition, complete relative-path cross-references, to-do plan terminology, and `Test Build Rule` narrow exception fidelity.
